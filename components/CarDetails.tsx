...
// chamar o transferencia entre a pagina inicial e a pagina dos dados do carro
                  ...
                  <div className='mt-3 flex flex-wrap gap-4'>
                    {Object.entries(car).map(([ key, value]) => (
                      <div className='flex justify-between gap-5 w-full text-right' key={key}>
                        <h4 className="text-grey capitalize">{translations[key as keyof typeof translations] || key}</h4>
